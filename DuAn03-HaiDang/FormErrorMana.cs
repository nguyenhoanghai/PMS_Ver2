    ...
    public partial class FrmErrorMana : Form
    {
        ...
        private Error BuildModel()
        {
            ...
            try
            {
                ...
                var phase = (PhaseModel)cbPhase.SelectedItem;
        ...
        private void LoadDataToCbbPhase()
        {
            try
            {
                cbPhase.DataSource = null;
                var items = BLLBTP_HCStructure.Instance.Gets((int)ePhaseType.LOI);
                if (items != null)
                {
                    cbPhase.DataSource = items;
        ...
        private void gridView2_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                cbPhase.Text = (gridView2.GetRowCellValue(gridView2.FocusedRowHandle, "PhaseName")!= null? gridView2.GetRowCellValue(gridView2.FocusedRowHandle, "PhaseName").ToString():"");
        ...
        private void btnReloadPhase_Click(object sender, EventArgs e)
        {
            LoadDataToCbbPhase();
        }
    }
