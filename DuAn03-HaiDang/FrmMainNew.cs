...
autoSetDayInfo = 0,
        ...
        {
            var result = ActiveForm(typeof(frmColor));
            if (!result)
            {
                var f = new frmColor();
                f.MdiParent = this;
        ...
        private void barbtnSize_ItemClick(object sender, ItemClickEventArgs e)
        {
            var result = ActiveForm(typeof(frmSize));
            if (!result)
            {
                var f = new frmSize();
                f.MdiParent = this;
